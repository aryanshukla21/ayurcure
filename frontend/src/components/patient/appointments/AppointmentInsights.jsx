    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2 bg-[#648B74] rounded-2xl p-8 text-white relative overflow-hidden shadow-sm">
         <div className="relative z-10">
           ...
           <p className="text-base text-white/90 mb-8 max-w-lg">
             Review your pre-consultation guidelines and dietary observations to make the most of your session with Dr. Ananya Iyer.
           </p>
           <div className="flex gap-4">
             <span className="px-4 py-2 bg-white/20 rounded-full text-xs font-bold uppercase tracking-wider backdrop-blur-sm border border-white/10 shadow-sm">Empty Stomach</span>
             <span className="px-4 py-2 bg-white/20 rounded-full text-xs font-bold uppercase tracking-wider backdrop-blur-sm border border-white/10 shadow-sm">Journal Ready</span>
             <span className="px-4 py-2 bg-white/20 rounded-full text-xs font-bold uppercase tracking-wider backdrop-blur-sm border border-white/10 shadow-sm">Quiet Space</span>
           </div>
         </div>
      ...
      <div className="lg:col-span-1 bg-[#7C6CA6] rounded-2xl p-8 text-white text-center flex flex-col items-center justify-center relative overflow-hidden shadow-sm">
        ...
        <p className="text-sm text-white/90 italic leading-relaxed px-2">
          "Patience is the foundation of healing. Your body knows how to return to balance, we only guide it."
        </p>
