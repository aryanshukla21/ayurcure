...
const EarningsSummaryCard = ({ earnings }) => {
    return (
        <div className="bg-white rounded-3xl p-10 shadow-sm border border-gray-100 h-4/5 flex flex-col">
            <div className="flex justify-between items-center mb-10">
                <h3 className="text-xl font-extrabold text-gray-900">Earnings Summary</h3>
