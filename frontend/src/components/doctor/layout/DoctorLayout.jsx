                ...
                <header className="h-16 pt-5 px-10 flex items-center justify-between bg-[#FDF9EE] z-10">
                    ...
                    <div className="relative w-full max-w-lg">
                        ...
                        <input
                            ...
                            className="w-full h-10 pl-14 pr-6 py-4 bg-[#EEE8D7] border-none rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#4A7C59]/30 shadow-sm text-xs text-black placeholder-gray-700 transition-shadow"
                        />
                    </div>
