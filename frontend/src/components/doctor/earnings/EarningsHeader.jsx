...
const EarningsHeader = () => {
    return (
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
            ...
            <div>
                <p className='text-amber-800 font-bold text-lg pb-3 uppercase'> Financial Overview</p>
                <h1 className="text-5xl font-extrabold text-gray-900 mb-3 tracking-tight">Earnings</h1>
            </div>
