            ...
            <div className="flex-1 w-full flex flex-col justify-center py-2">
                ...
                <div className="flex justify-between items-start mb-2">
                    <div>
                        ...
                        <p className="text-gray-500 font-bold text-xs tracking-wide">{appointment.patient_id}</p>
                    </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-y-6 gap-x-4 py-4 border-t border-gray-100">
                    <div>
                        <p className="text-xs text-gray-400 font-bold tracking-widest uppercase mb-2">Age / Gender</p>
                        <p className="text-gray-900 font-extrabold text-xs">{appointment.age} / {appointment.gender}</p>
                    </div>
                ...
                <div>
                    ...
                    <div className="flex items-center gap-2 text-gray-900 font-extrabold text-xs">
                        {appointment.mode === 'Video' ? <Video size={12} className="text-[#4A7C59]" /> : <User size={20} className="text-[#4A7C59]" />}
                        {appointment.mode}
                    </div>
                </div>
