...
export const Input = ({ type = "text", ...props }) => (
    <input
        type={type}
        className="w-full text-xs bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 text-gray-900 font-bold focus:outline-none focus:border-[#4A7C59] focus:ring-1 focus:ring-[#4A7C59] focus:bg-white transition-all placeholder-gray-400"
        {...props}
    />
);
...
export const TextArea = ({ ...props }) => (
    <textarea
        className="w-full bg-[#f9f2de] border text-sm border-gray-100 rounded-xl px-6 py-4 text-gray-900 font-medium focus:outline-none focus:border-[#4A7C59] focus:ring-1 focus:ring-[#4A7C59] focus:bg-white transition-all resize-none placeholder-gray-400"
        rows="4"
        {...props}
    ></textarea>
);
