...
/**
 * Helper: Retrieves the Doctor Profile ID associated with the authenticated User ID.
 */
...
exports.submitProfile = async (req, res) => {
    try {
        ...
        if (error.code === '23505') {
            return res.status(409).json({ error: 'Medical registration number already in use.' });
        }
...
exports.updateAvailability = async (req, res) => {
    try {
        ...
        // Expecting { day_of_week, start_time, end_time }
